            ...
            <div class="col-7">
                ...
                <div class="row mb-2">
                    ...
                    <div class="card-header py-3"> 
                        <div class="row mb-2">
                                <div class="col-4">
                                        <h5 class="m-0 font-weight-bold text-black">Daftar Kelas</H5>  
                                    </div>
                                        <div class="col-2">
                                                <div class="input-group">
                                                </div></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped dataTable" width="100%" cellspacing="0" id="dataTable">
                                    ...
                                    <tbody>
                                            <?php $count = 0;foreach ($kelas as $u) : ?>
                                                <tr>
                                                <td><?= ++$count ?></td>
                                                <td><?= $u['nama_kelas']; ?></td>
                                                <?php if ($u['status_kelas'] == 1) { ?>
                                                ...
                                                <td><div class="btn-group">
                                                            <button class="btn btn-sm btn btn-outline-light" style="color:#4169E1;" onclick="editdata(<?= $u['id_kelas']?>)">
                                                                <i class="fas fa-pen"></i>
                                                            </button>
                                                    
                                                            <button class=" btn btn-outline-light"onclick="deleted(<?= $u['id_kelas']?>,'<?= $u['nama_kelas']?>')" title="Hapus Data"
                ...
                <div class="col-4"></div>
                 ...
                 <div class="col-2"></div>
                    ...
                    <div class="card-header py-3"> 
                        <div class="row mb-2">
                             <div class="col-6">
                                <h5 class="m-0 font-weight-bold text-black">Tambah Kelas </H5>  
                            </div>
                             <div class="col-2"></div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 class="modal-title font-weight-bold ">Edit Kelas</h6>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                                    <label for="kelas">Nama Kelas</label>
                                    <input type="text" class="form-control" id="kelas1" name="kelas1" required>
                                    <div class="invalid-feedback errorkelas"></div>
                                </div>
                                <div class="form-group ">
                                    <label for="inputState">Status</label>
